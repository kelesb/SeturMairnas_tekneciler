...
- Dizin geçişi korunarak yalnızca tam adı `.env.example` olan env örnek şablonları ignore kapsamı dışında bırakıldı; güvenli temel şablonların versiyonlanması açık tutuldu
