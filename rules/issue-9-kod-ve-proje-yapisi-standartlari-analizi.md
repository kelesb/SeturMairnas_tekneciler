...
- Repository kökünde uygulama kaynak kodu, solution/proje dosyası, controller/service sınıfları, dependency injection yapılandırması veya test projesi bulunmamaktadır.
